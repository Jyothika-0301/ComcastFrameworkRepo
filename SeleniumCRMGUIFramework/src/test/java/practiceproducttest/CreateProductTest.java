...
public class CreateProductTest {
	public static void main(String[] args) throws IOException {
		...
		FileInputStream fis1 = new FileInputStream("./src/test/resources/testData/product.xlsx");
		
		Workbook wb = WorkbookFactory.create(fis1);
		Sheet sh =  wb.getSheet("Sheet1");
		Row row = sh.getRow(1);
		String prodName = row.getCell(2).toString()+randomInt;		
		wb.close();
